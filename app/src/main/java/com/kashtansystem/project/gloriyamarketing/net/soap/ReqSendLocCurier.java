...
public class ReqSendLocCurier
{
    public static String[] send(String userCode, double latitude, double longitude)
    {
        final String soapAction = "http://www.sample-package.org#MobileAgents:SetGPSCurier";

        SoapObject request = new SoapObject(C.SOAP.NAME_SPACE, "SetGPSCurier");
